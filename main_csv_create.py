...
from database import DatabaseManager, CSVGenerator
...
def main():
    ...
    # Создание CSV файла и загрузка данных в БД
    db_manager = DatabaseManager()
    csv_generator = CSVGenerator(db_manager)
    csv_generator.generate_csv_file()
    csv_generator.load_data_from_csv()
